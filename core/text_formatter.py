...
class TextFormatter:
    ...
    def format_help() -> str:
        ...
        lines = [
            ...
            "━━━━━━━━━━━━━━",
            "🤖【自然语言 @机器人 使用（最方便）】：",
            "• 借钱给别人：@Bot 我借给 @张三 50元 买奶茶 (或 @Bot 狗子 欠我 50)",
            "• 垫付/记欠款：@Bot @李四 欠我 100 块打车费",
            "• 向别人借钱：@Bot 我向 @王五 借了 30 块吃午饭",
            "• 记录已还款：@Bot 我还给 @张三 50 元 微信已转 (或 @Bot 狗子 还了我 30)",
            "• 一键全还清：@Bot 我还清了 @张三 (或 @Bot 结清 狗子)",
            "• 查双人账目：@Bot 查一下我和 @张三 的账 (或 @Bot 查账 狗子)",
            "• 查个人总账：@Bot 我的账单 / 谁欠我钱",
            "• 绑定外号：@Bot 把 @张三 设置外号为 狗子",
            "• 同意或拒绝：@Bot 同意 / @Bot 拒绝",
            "━━━━━━━━━━━━━━",
            "⚡【快捷指令列表】：",
            "• /借出 @某人 [金额] [事由] : 记录借给对方钱",
            "• /借入 @某人 [金额] [事由] : 记录向对方借钱",
            "• /还款 @某人 [金额] [事由] : 记录还款给对方",
            "• /还清 @某人 [事由] : 一键结清与该好友的全部净欠款",
            "• /别名 @某人 [外号] : 为好友绑定外号（后续可免@直接用外号记账）",
            "• /别名列表 : 查看已绑定的所有外号",
            "• /同意 [单号] : 同意借还款申请真实入账",
            "• /拒绝 [单号] : 拒绝借还款申请",
            "• /撤销 [单号] : 发起人撤销未确认申请",
